...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        const db = new db_model_1.default('panel', 5432, 'localhost', config_1.DB_USER, config_1.DB_PASS);
        yield (0, sql_executer_1.default)('schema.sql', db, { baseDir: path_1.default.resolve(__dirname, '..') });
        ...
        app.get('/api/profile', authToken_1.authenticateToken, (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            res.status(200).json({ username: user === null || user === void 0 ? void 0 : user.username, email: user === null || user === void 0 ? void 0 : user.email });
        }));
        app.get('/', (_req, res) => {
